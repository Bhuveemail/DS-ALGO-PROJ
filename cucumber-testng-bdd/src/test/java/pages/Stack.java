...
public class Stack {
	...
	//Homepage Stack
		...
		public static By Implementation=By.xpath("//*[contains(@href,'implementation')]");
		public static By Applications=By.xpath("//*[@href='stack-applications']");
		public static By ApplicationsLink=By.xpath("//*[@href='/stack/stack-applications/']");
